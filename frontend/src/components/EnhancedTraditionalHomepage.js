...
import { Truck, MapPin, Phone, Mail, Users, Shield, Navigation, Clock, Building2, Award, Globe, CheckCircle, Package, Target, Anchor, Map, Route, Calendar, Trophy, Star, Certificate } from "lucide-react";
...
const EnhancedTraditionalHomepage = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['welcome', 'services', 'routes', 'timeline', 'certifications', 'fleet', 'partners', 'team'];
