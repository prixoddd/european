...
const CorporateHomepage = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            {/*>*/}
            <header
                className="fixed top-0 w-full z-50 transition-all duration-300 bg-white border-b border-gray-100 shadow-sm"
            >
                        ...
                        <div className="space-y-8">
                            <div className="space-y-6">
                                ...
                                <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-[1.1] tracking-tight">
                                    Delivering
                                    <span className="text-brand-red block"> Excellence</span>
                                    <span className="text-brand-blue block"> Across Europe</span>
                                </h1>
                                <div
