...
const CorporateHomepage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 w-full bg-white/98 backdrop-blur-md border-b border-gray-100 z-50 shadow-sm">
      ...
      <section id="welcome" className="pt-32 pb-20 bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <div className="w-20 h-1.5 bg-gradient-to-r from-brand-red to-brand-blue rounded-full"></div>
              </div>
              ...
              <div className="flex items-center space-x-6 pt-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-gray-700">24+ Years Experience</span>
                </div>
                <div className="flex items-center space-x-2">
      ...
      <section id="fleet" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-6">State-of-the-Art Fleet Management</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="text-center p-4 bg-green-50 rounded-xl">
                      <p className="text-2xl font-bold text-green-600">Euro 5-6</p>
